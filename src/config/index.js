...
const loadAppConfig = () => {
  ...
  window.__config = {
    ...
    _STATIC_API: import.meta.env.VITE_APP_STATIC_API || 'https://reszerog0.oss-cn-hongkong.aliyuncs.com'
  }
 ...
 * 注册邀请码必填 配置(账号，邮箱)
 */
export const REGISTER_REQUIRED_ACTIVECODE = ['bitbyex','trustdefi']
// 手机注册邀请码
...
const config = {
  _APP_ENV: 'test',
  _BASE_API: 'https://your-test-api.com',
  _STATIC_API: 'https://your-test-static.com'
}